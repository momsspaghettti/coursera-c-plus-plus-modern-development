...
namespace Svg {
    ...
    class Rect : public SvgBase<Rect> {
    public:
        Rect &SetCorner(Point);
    ...
    public:
        Document() {
            objects_ = std::make_shared<std::vector<std::shared_ptr<SvgObject>>>();
        }

        Document(const Document &other) {
            objects_ =
                    std::make_shared<std::vector<std::shared_ptr<SvgObject>>>(
                            *other.objects_
                    );
        }
    ...
    private:
        std::shared_ptr<std::vector<std::shared_ptr<SvgObject>>> objects_;
    };
}